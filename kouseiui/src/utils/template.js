...
; (function (root, factory) {
    ...
    var o = {
        sTag: '<%',// Start tag
        eTag: '%>',// End tag
        compress: false,// Whether to compress html
        escape: true, // Is HTML escape performed by default?
    ...
    function parse(tpl, opt) {
        ...
        function parsehtml(line) {
            // Escape single and double quotes, replace line breaks with spaces
    ...
    function compiler(tpl, opt) {
        ...
        code = code.replace(/[\r]/g, ' '); // ie 7 8 It will report an error, I don't know why
        try {
