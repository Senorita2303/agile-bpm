    ...
    <el-container>
      ...
      <el-main>
        <div class="comprehensive-table-container">
          ...
          >
            <ab-column label="Name" min-width="150" prop="name" />
            <ab-column label="Code" min-width="120" prop="code" />
            <ab-column label="Business Object Code" min-width="120" prop="boCode" />
            <ab-column label="Business Object" min-width="120" prop="boName" />
            <ab-column
            ...
            <ab-column
              ...
              width="150"
            />
            <ab-column label="Operator" min-width="70" prop="operator" />
            <ab-column
              ab-template="edit"
              fixed="right"
              label="Action"
