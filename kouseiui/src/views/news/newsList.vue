<template>
  <div class="comprehensive-table-container" style="padding:16px;background-color:#fff;height: 100%;">
    ...
    <ab-table ref="abTable" v-model="selectedData" :height="tableHeight" :query-param="query" row-key="id" :url="cmsApi.news.cmsNewsListUrl">
      <ab-column label="Title" min-width="160" prop="title" />
      <ab-column ab-text-formatter="0-Not published-default-light|1-Release-success-light|2-Remove-danger-light" align="left" label="Status" prop="status" width="90" />
      ...
      <ab-column label="Comments Num" prop="commentsNum" width="90" />
