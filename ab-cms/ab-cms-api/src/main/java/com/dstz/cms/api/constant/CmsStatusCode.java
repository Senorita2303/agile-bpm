...
public enum CmsStatusCode implements IBaseCode {
    ...
    BUS_SRC_STS_UPDATE("busSrcStsUpdate", "The resource status to be operated has changed and the operation cannot be performed"),
    NOTIFY_READ_ONLY("notifyReadOnly", "The current announcement has been published. The published announcement cannot be modified."),
    NEWS_READ_ONLY("newsReadOnly", "The current news has been published. The published news cannot be modified."),
    NOTIFY_DELETE_DISABLED("notifyDeleteDisabled", "The current announcement is in the release state, please remove the announcement before deleting it!"),
    NEWS_DELETE_DISABLED("newsDeleteDisabled", "The current news is in the release state, please remove the announcement before deleting it!"),
    DOCUMENT_DELETE_FAIL("documentDeleteFail", "Deletion failed, there are documents in this directory, please modify the directory to which the documents belong first!"),
